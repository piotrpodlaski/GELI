...
private:
	...
	int A1; ///< Mass number of the first reaction product
	int A2; ///< Mass number of the second reaction product
	int Z1; ///< Atomic number of the first reaction product
	int Z2; ///< Atomic number of the second reaction product
